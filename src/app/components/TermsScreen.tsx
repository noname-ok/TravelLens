    ...
    <div className="bg-white dark:bg-gray-900 relative size-full">
      ...
      <div className="relative mx-auto w-full max-w-[390px] h-full">
        ...
        <div className="absolute left-[27px] top-[62px] w-[341px] h-[23px] flex items-center justify-between">
          ...
          <p className="font-['Poppins',sans-serif] font-medium text-[15px] text-black dark:text-white">Terms and Conditions</p>
        ...
        >
          <div className="mt-4 space-y-6 pb-20">
            ...
            <div className="space-y-2">
              <h2 className="font-['Poppins',sans-serif] font-bold text-[20px] text-[#2c638b] dark:text-blue-400">Adventure Awaits!</h2>
              <p className="font-['Poppins',sans-serif] text-[12px] leading-[20px] text-[rgba(0,0,0,0.6)] dark:text-gray-400">
            ...
            {/* Section 1 */}
            <div className="space-y-2">
              <h3 className="font-['Poppins',sans-serif] font-semibold text-[14px] text-black dark:text-white">1. Exploring Responsibility</h3>
              <p className="font-['Poppins',sans-serif] text-[12px] leading-[20px] text-[rgba(0,0,0,0.7)] dark:text-gray-400">
            ...
            {/* Section 2 */}
            <div className="space-y-2">
              <h3 className="font-['Poppins',sans-serif] font-semibold text-[14px] text-black dark:text-white">2. Your Photos, Your Rights</h3>
              <p className="font-['Poppins',sans-serif] text-[12px] leading-[20px] text-[rgba(0,0,0,0.7)] dark:text-gray-400">
            ...
            {/* Section 3 */}
            <div className="space-y-2">
              <h3 className="font-['Poppins',sans-serif] font-semibold text-[14px] text-black dark:text-white">3. The AI Lens & Accuracy</h3>
              <p className="font-['Poppins',sans-serif] text-[12px] leading-[20px] text-[rgba(0,0,0,0.7)] dark:text-gray-400">
            ...
            {/* Section 4 */}
            <div className="space-y-2">
              <h3 className="font-['Poppins',sans-serif] font-semibold text-[14px] text-black dark:text-white">4. Community Conduct</h3>
              <p className="font-['Poppins',sans-serif] text-[12px] leading-[20px] text-[rgba(0,0,0,0.7)] dark:text-gray-400">
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
              <p className="font-['Poppins',sans-serif] text-[10px] text-[rgba(0,0,0,0.4)] dark:text-gray-500 italic text-center">
            ...
            <div className={`transition-all duration-500 flex flex-col items-center gap-4 py-8 ${hasReadToBottom ? 'opacity-100' : 'opacity-20'}`}>
              ...
              {hasReadToBottom ? (
                ...
                <p className="font-['Poppins'] text-[10px] text-gray-400 dark:text-gray-500 italic animate-pulse">
